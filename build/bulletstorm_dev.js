...
// include: C:\Users\simon\AppData\Local\Temp\tmpog4d3l_h.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/bulletstorm_dev.data';
      var REMOTE_PACKAGE_BASE = 'bulletstorm_dev.data';
...
Module['FS_createPath']("/assets/textures", "arena", true, true);
Module['FS_createPath']("/assets/textures/arena", "guns", true, true);
Module['FS_createPath']("/assets/textures/arena", "maps", true, true);
Module['FS_createPath']("/assets/textures", "player", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/bulletstorm_dev.data');

      };
      Module['addRunDependency']('datafile_build/bulletstorm_dev.data');
    ...
    loadPackage({"files": [{"filename": "/assets/fonts/alagard.png", "start": 0, "end": 6213}, {"filename": "/assets/fonts/editundo.ttf", "start": 6213, "end": 23381}, {"filename": "/assets/levels/level_1.bin", "start": 23381, "end": 24261}, {"filename": "/assets/levels/level_2.bin", "start": 24261, "end": 25289}, {"filename": "/assets/levels/level_3.bin", "start": 25289, "end": 25969}, {"filename": "/assets/textures/arena/guns/drone.png", "start": 25969, "end": 27253}, {"filename": "/assets/textures/arena/guns/drone_thick.png", "start": 27253, "end": 28438}, {"filename": "/assets/textures/arena/guns/explosion.png", "start": 28438, "end": 31426}, {"filename": "/assets/textures/arena/guns/fireball.png", "start": 31426, "end": 31766}, {"filename": "/assets/textures/arena/guns/lasergun.png", "start": 31766, "end": 137441}, {"filename": "/assets/textures/arena/maps/autumn.png", "start": 137441, "end": 1057202}, {"filename": "/assets/textures/arena/maps/spring.png", "start": 1057202, "end": 2198923}, {"filename": "/assets/textures/arena/maps/summer.png", "start": 2198923, "end": 3218873}, {"filename": "/assets/textures/arena/maps/winter.png", "start": 3218873, "end": 6838844}, {"filename": "/assets/textures/player/blue.png", "start": 6838844, "end": 6841635}, {"filename": "/assets/textures/player/main.py", "start": 6841635, "end": 6842899}, {"filename": "/assets/textures/player/orange.png", "start": 6842899, "end": 6845612}, {"filename": "/assets/textures/player/player.png", "start": 6845612, "end": 6875397}, {"filename": "/assets/textures/player/white.png", "start": 6875397, "end": 6876987}], "remote_package_size": 6876987});

  })();

// end include: C:\Users\simon\AppData\Local\Temp\tmpog4d3l_h.js
// include: C:\Users\simon\AppData\Local\Temp\tmpb_00ylcy.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\simon\AppData\Local\Temp\tmpb_00ylcy.js
// include: C:\Users\simon\AppData\Local\Temp\tmptyzs7rpj.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\simon\AppData\Local\Temp\tmptyzs7rpj.js
...
var ASM_CONSTS = {
  48168: () => { if (document.fullscreenElement) return 1; },  
 48214: () => { return document.getElementById('canvas').width; },  
 48266: () => { return parseInt(document.getElementById('canvas').style.width); },  
 48334: () => { document.exitFullscreen(); },  
 48361: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 48434: () => { if (document.fullscreenElement) return 1; },  
 48480: () => { return document.getElementById('canvas').width; },  
 48532: () => { return screen.width; },  
 48557: () => { document.exitFullscreen(); },  
 48584: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 48717: () => { return window.innerWidth; },  
 48743: () => { return window.innerHeight; },  
 48770: () => { if (document.fullscreenElement) return 1; },  
 48816: () => { return document.getElementById('canvas').width; },  
 48868: () => { return parseInt(document.getElementById('canvas').style.width); },  
 48936: () => { if (document.fullscreenElement) return 1; },  
 48982: () => { return document.getElementById('canvas').width; },  
 49034: () => { return screen.width; },  
 49059: () => { return window.innerWidth; },  
 49085: () => { return window.innerHeight; },  
 49112: () => { if (document.fullscreenElement) return 1; },  
 49158: () => { return document.getElementById('canvas').width; },  
 49210: () => { return screen.width; },  
 49235: () => { document.exitFullscreen(); },  
 49262: () => { if (document.fullscreenElement) return 1; },  
 49308: () => { return document.getElementById('canvas').width; },  
 49360: () => { return parseInt(document.getElementById('canvas').style.width); },  
 49428: () => { document.exitFullscreen(); },  
 49455: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 49513: () => { return screen.width; },  
 49538: () => { return screen.height; },  
 49564: () => { return window.screenX; },  
 49591: () => { return window.screenY; },  
 49618: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 49671: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 49742: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 49799: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 50055: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 50126: () => { if (document.fullscreenElement) return 1; },  
 50172: () => { return window.innerWidth; },  
 50198: () => { return window.innerHeight; },  
 50225: () => { if (document.pointerLockElement) return 1; }
};
